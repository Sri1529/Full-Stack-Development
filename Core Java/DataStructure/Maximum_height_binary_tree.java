...
public class Maximum_height_binary_tree {
	...
	//constructer calls default to set root as null
	
	public Maximum_height_binary_tree()
	{
		root=null;
	}
	...
	public static void main(String[] args) {
		...
		Maximum_height_binary_tree bt = new Maximum_height_binary_tree();
		bt.root = new Node(1);
